# FaxMachine Workspace

This is the working directory for the FaxMachine Hermes profile.

SOUL.md is not stored here.
Hermes loads SOUL.md from the active Hermes profile home.
